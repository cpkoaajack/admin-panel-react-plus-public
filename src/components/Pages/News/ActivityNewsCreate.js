...
class ActivityNewsCreate extends Component {
  constructor(props) {
    super(props);
    this.state = {
      /* Indicator */
  ...
  fetchActivityNewsCreateRequest = async () => {
  ...
  handleActivityNewsCreate = async (event) => {
    ...
    try {
      ...
      if (response) {
        ...
        response = await this.fetchActivityNewsCreateRequest();
      } else {
  ...
  render() {
    ...
    if (!isFetch) {
      ...
      return (
        <div className='activity-news-create'>
          <div className='item-edit-header'>
            <header style={this.style.header}>
              <Typography component='h1' variant='h5'>
                Create Activity News
              </Typography>
            </header>
          </div>
          <div className='item-edit-body'>
            <Container>
              <form onSubmit={this.handleActivityNewsCreate}>
...
export default ActivityNewsCreate;
