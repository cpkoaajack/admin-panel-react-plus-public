...
class ActivityTagCreate extends Component {
  constructor(props) {
    super(props);
    this.state = {
      /* Indicator */
  ...
  fetchTagActivityCreateRequest = async () => {
    ...
    try {
      ...
      if (response.success) {
        console.log('Activity Tag Create Success');

        this.setState({
          isSuccess: true,
        });
      } else {
        console.log('Activity Tag Create Failed:', response.message);
        this.setState({
  ...
  handleActivityTagCreate = async () => {
    ...
    try {
      ...
      if (response) {
        ...
        response = await this.fetchTagActivityCreateRequest();
      } else {
...
export default ActivityTagCreate;
